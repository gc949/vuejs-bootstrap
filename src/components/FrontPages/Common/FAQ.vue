  ...
  <div class="faq-arae position-relative z-1 pt-125" id="fqss">
    <div class="container">
      <div class="section-title mw-630">
        ...
        <h2>Inspiring Feedback: What Users Love About Trz Dashboard</h2>
      </div>
      ...
      <div class="accordion faq-wrapper mw-740 m-auto" id="accordionExample">
        <div class="accordion-item mb-3 border-0 bg-white">
          <h2 class="accordion-header">
            <button
              class="accordion-button text-secondary bg-white"
              type="button"
        ...
        <div class="accordion-item mb-3 border-0 bg-white">
          <h2 class="accordion-header">
            <button
              class="accordion-button text-secondary bg-white collapsed"
              type="button"
              data-bs-toggle="collapse"
