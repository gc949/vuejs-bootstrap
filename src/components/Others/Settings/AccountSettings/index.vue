          ...
          <div class="col-lg-6">
            <div class="form-group mb-4">
              ...
              <div class="form-group position-relative">
                ...
                <i
                  class="ri-line-chart-fill position-absolute top-50 start-0 translate-middle-y fs-20 text-gray-light ps-20"
                ></i>
              </div>
            </div>
          </div>
          <div class="col-lg-6">
            <div class="form-group mb-4">
              ...
              <div class="form-group position-relative">
                ...
                <i
                  class="ri-honour-line position-absolute top-50 start-0 translate-middle-y fs-20 text-gray-light ps-20"
                ></i>
              </div>
            </div>
          </div>
