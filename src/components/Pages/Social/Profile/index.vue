<template>
  <div class="row">
    <div class="col-xxl-9">
          ...
          <div class="d-flex justify-content-between flex-wrap gap-3">
            <div class="d-flex align-items-end">
              <div class="flex-shrink-0 position-relative mt-minus-110">
                <img
                  src="@/assets/images/user-68.jpg"
                  class="rounded-circle border border-2 wh-160"
                  alt="user"
                />
                <img
            ...
            <div class="d-flex align-items-center">
              <a
                href="#"
                class="btn btn-outline-light text-body fw-medium fs-16 px-4 hover hover-bg"
              >
                <i class="ri-edit-line fw-medium fs-18 me-2"></i>
                <span>Edit</span>
              </a>
              <a href="#" class="btn btn-primary fw-medium fs-16 px-4 ms-3">
                <i class="ri-share-fill fw-medium fs-18 me-2"></i>
                <span>Share</span>
              </a>
            </div>
          </div>
      ...
      <ul
        class="nav nav-tabs profile-tabs border-0 justify-content-center gap-2 mb-4"
        id="myTab"
        role="tablist"
      >
        <li class="nav-item" role="presentation">
          <button
            class="nav-link border-1 border-primary rounded-2 fw-medium active"
            id="timeline-tab"
            data-bs-toggle="tab"
        ...
        <li class="nav-item" role="presentation">
          <button
            class="nav-link border-1 border-primary rounded-2 fw-medium"
            id="about-tab"
            data-bs-toggle="tab"
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            <div class="flex-shrink-0 position-relative">
                              ...
                              />
                              <div
                                class="position-absolute p-1 bg-danger border border-2 border-white rounded-circle status-position2"
                              ></div>
                            </div>
                            <div
                              class="flex-grow-1 ms-2 position-relative top-2"
                            >
          ...
          <div class="tab-content" id="myTabContent">
            ...
            >
                ...
                <div class="card-body p-4">
                  ...
                  <form>
                    ...
                    <div class="d-flex align-items-center gap-3">
                      <button
                        class="btn btn-primary py-2 px-3 align-items-center d-flex fs-16 fw-medium"
                      >
                        <i class="material-symbols-outlined text-white me-2">
                          send
                        </i>
                        <span class="py-1 d-none d-sm-inline-block">
                          Publish Post
                        </span>
                      </button>
                      <button
                        class="p-0 bg-transparent border-0 fs-20 text-body hover"
                      >
              ...
              <div class="card bg-white border-0 rounded-3 mb-4">
                <div class="card-body p-4">
                  ...
                  <div class="border-top border-bottom py-2 my-4">
                    ...
                    >
                      <button
                        class="p-0 bg-transparent border-0 fs-20 text-body hover align-items-center d-flex"
                      >
                  ...
                  <form>
                    ...
                    >
                      ...
                      <div class="d-flex align-items-center gap-3 ms-3">
                        <button
                          class="p-0 bg-primary border-0 wh-44 lh-56 rounded-2"
                        >
              ...
              <div class="card bg-white border-0 rounded-3 mb-4">
                <div class="card-body p-4">
                  <div
                    class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-2"
                  >
                    <a
                      href="#"
                      class="d-flex align-items-center text-decoration-none"
            ...
            >
              <div class="card bg-white border-0 rounded-3 mb-4">
                <div class="card-body p-4">
                  <div
                    class="d-flex justify-content-between align-items-center flex-wrap gap-2 border-bottom pb-4 mb-4"
                  >
                  ...
                  <p class="mb-4" style="max-width: 691px">
                    Alice Johnson, a visionary UX/UI designer, blends creativity
                    with user-centric design principles to craft seamless
                    digital experiences. With a passion for innovation and a
                    knack for understanding user needs, [Your Name] has become a
                    driving force in the ever-evolving landscape of digital
                    design. This 5000-word biography aims to delve into Alice's
                    journey, from humble beginnings to becoming a recognized
                    name in the realm of user experience and interface design.
                  </p>

                  <h4 class="fs-16 fw-medium mb-2">Professional Beginnings</h4>
                  <p class="mb-4" style="max-width: 691px">
                    Upon graduating, Alice embarked on their professional
                    journey, eager to make an impact in the world of design.
                    They initially gained experience working at VivoTech, where
                    they collaborated with cross-functional teams to deliver
                    user-centric solutions for various clients. This early
                    exposure provided invaluable insights into the complexities
                    of design processes and solidified Alice's commitment to
                    enhancing user experiences.
                  </p>

                  <h4 class="fs-16 fw-medium mb-2 pb-1">
                    Expertise in UX/UI Design
                  </h4>
                  <p style="max-width: 691px">
                    Driven by a desire for continuous growth, Alice delved
                    deeper into the nuances of UX/UI design, staying abreast of
                    emerging trends, technologies, and methodologies. They
                    immersed themselves in user research, wireframing,
                    prototyping, and usability testing, refining their craft
                    with each project.
                  </p>
                </div>
              </div>
                ...
                <div class="card-body p-4">
                  ...
                  <div class="position-relative timeline-item">
                    ...
                    <div class="border-style-for-timeline">
                      <h4 class="fs-14 fw-medium mb-2">
                        Weekly Stand-Up Meetings:
                      </h4>
                      <p class="fs-13">
                        We continued our weekly stand-up meetings where team
                        members provided updates on their current tasks,
                        discussed any roadblocks, and coordinated efforts for
                        the week ahead.
                      </p>
                      <p>
                        By: <span class="text-primary">Olivia Rodriguez</span>
                      </p>
                    </div>
                  </div>
                  <div class="position-relative timeline-item">
                    ...
                    <div class="border-style-for-timeline dot-2">
                      ...
                      <p class="fs-13">
                        The session included introductions, a review of project
                        goals and objectives, and initial planning discussions.
                      </p>
                      <p>
                        By: <span class="text-primary">Isabella Cooper</span>
                      </p>
                    </div>
                  </div>
                  <div class="position-relative timeline-item">
                    ...
                    <div class="border-style-for-timeline dot-3">
                      ...
                      <p class="fs-13">
                        Last Friday, we conducted a team building workshop
                        focused on improving communication and collaboration
                        among team members. Activities included team challenges,
                        icebreakers, and open discussions.
                      </p>
                  ...
                  <div class="position-relative timeline-item">
                    ...
                    <div class="border-style-for-timeline dot-4 pb-0">
                      ...
                      <p class="fs-13">
                        We organized a lunch and learn session on March 15th
                        where a guest speaker from the industry discussed
                        emerging trends in our field. It was an insightful
                        session that sparked valuable discussions among team
                        members.
                      </p>
            ...
            <div class="card-body p-4">
              ...
              <div class="d-flex align-items-center mb-4">
                <div class="flex-shrink-0">
                  <img
                    src="@/assets/images/user-68.jpg"
                    class="rounded-circle border border-2 wh-75"
                    alt="user"
                  />
                </div>
                <div class="flex-grow-1 ms-3">
