                ...
                <div class="form-group mb-4">
                  ...
                  >
                    <div class="product-upload">
                      <label for="file-upload" class="file-upload mb-0">
                        <i
                          class="ri-file-line bg-primary bg-opacity-10 p-2 rounded-1 text-primary"
                        ></i>
                        <span class="d-block text-body fs-14">
              ...
              <div class="col-lg-12">
                <div class="d-flex flex-wrap gap-3">
                  ...
                  <button class="btn btn-primary py-2 px-4 fw-medium fs-16">
                    <i class="ri-add-line text-white fw-medium"></i> Save
                    Information
                  </button>
                </div>
              </div>
      ...
      <div class="card bg-white border-0 rounded-3 mb-4">
        <div class="card-body p-4">
          ...
          <div class="d-flex flex-wrap gap-3">
            ...
            <button class="btn btn-primary py-2 px-4 fw-medium fs-16">
              <i class="ri-arrow-left-right-line text-white fw-medium"></i>
              Transfer Account
            </button>
          </div>
        </div>
