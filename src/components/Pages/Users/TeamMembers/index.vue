        ...
        <div class="card bg-white border-0 rounded-3 mb-4">
          <div class="card-body p-4">
            ...
            <div class="d-flex align-items-center mb-2 pb-1">
              ...
              <span class="ms-1">turner@mail.com</span>
            </div>
            <div class="d-flex align-items-center mb-2 pb-1">
      ...
      <div class="col-xxl-3 col-lg-4 col-sm-6">
        <div class="card bg-white border-0 rounded-3 mb-4">
          <div class="card-body p-4">
            ...
            <div class="d-flex align-items-center mb-2 pb-1">
              <span class="text-secondary">Email Address:</span>
              <span class="ms-1">parker@mail.com</span>
            </div>
            <div class="d-flex align-items-center mb-2 pb-1">
              <span class="text-secondary">Phone Number:</span>
      ...
      <div class="col-xxl-3 col-lg-4 col-sm-6">
        <div class="card bg-white border-0 rounded-3 mb-4">
          <div class="card-body p-4">
            ...
            <div class="d-flex align-items-center mb-2 pb-1">
              <span class="text-secondary">Email Address:</span>
              <span class="ms-1">lee@mail.com</span>
            </div>
            <div class="d-flex align-items-center mb-2 pb-1">
              <span class="text-secondary">Phone Number:</span>
      ...
      <div class="col-xxl-3 col-lg-4 col-sm-6">
        <div class="card bg-white border-0 rounded-3 mb-4">
          <div class="card-body p-4">
            ...
            <div class="d-flex align-items-center mb-2 pb-1">
              <span class="text-secondary">Email Address:</span>
              <span class="ms-1">torres@mail.com</span>
            </div>
            <div class="d-flex align-items-center mb-2 pb-1">
              <span class="text-secondary">Phone Number:</span>
      ...
      <div class="col-xxl-3 col-lg-4 col-sm-6">
        <div class="card bg-white border-0 rounded-3 mb-4">
          <div class="card-body p-4">
            ...
            <div class="d-flex align-items-center mb-2 pb-1">
              <span class="text-secondary">Email Address:</span>
              <span class="ms-1">lucas@mail.com</span>
            </div>
            <div class="d-flex align-items-center mb-2 pb-1">
              <span class="text-secondary">Phone Number:</span>
      ...
      <div class="col-xxl-3 col-lg-4 col-sm-6">
        <div class="card bg-white border-0 rounded-3 mb-4">
          <div class="card-body p-4">
            ...
            <div class="d-flex align-items-center mb-2 pb-1">
              <span class="text-secondary">Email Address:</span>
              <span class="ms-1">morgan@mail.com</span>
            </div>
            <div class="d-flex align-items-center mb-2 pb-1">
              <span class="text-secondary">Phone Number:</span>
      ...
      <div class="col-xxl-3 col-lg-4 col-sm-6">
        <div class="card bg-white border-0 rounded-3 mb-4">
          <div class="card-body p-4">
            ...
            <div class="d-flex align-items-center mb-2 pb-1">
              <span class="text-secondary">Email Address:</span>
              <span class="ms-1">sophia@mail.com</span>
            </div>
            <div class="d-flex align-items-center mb-2 pb-1">
              <span class="text-secondary">Phone Number:</span>
      ...
      <div class="col-xxl-3 col-lg-4 col-sm-6">
        <div class="card bg-white border-0 rounded-3 mb-4">
          <div class="card-body p-4">
            ...
            <div class="d-flex align-items-center mb-2 pb-1">
              <span class="text-secondary">Email Address:</span>
              <span class="ms-1">meade@mail.com</span>
            </div>
            <div class="d-flex align-items-center mb-2 pb-1">
              <span class="text-secondary">Phone Number:</span>
      ...
      <div class="col-xxl-3 col-lg-4 col-sm-6">
        <div class="card bg-white border-0 rounded-3 mb-4">
          <div class="card-body p-4">
            ...
            <div class="d-flex align-items-center mb-2 pb-1">
              <span class="text-secondary">Email Address:</span>
              <span class="ms-1">michael@mail.com</span>
            </div>
            <div class="d-flex align-items-center mb-2 pb-1">
              <span class="text-secondary">Phone Number:</span>
      ...
      <div class="col-xxl-3 col-lg-4 col-sm-6">
        <div class="card bg-white border-0 rounded-3 mb-4">
          <div class="card-body p-4">
            ...
            <div class="d-flex align-items-center mb-2 pb-1">
              <span class="text-secondary">Email Address:</span>
              <span class="ms-1">charles@mail.com</span>
            </div>
            <div class="d-flex align-items-center mb-2 pb-1">
              <span class="text-secondary">Phone Number:</span>
      ...
      <div class="col-xxl-3 col-lg-4 col-sm-6">
        <div class="card bg-white border-0 rounded-3 mb-4">
          <div class="card-body p-4">
            ...
            <div class="d-flex align-items-center mb-2 pb-1">
              <span class="text-secondary">Email Address:</span>
              <span class="ms-1">tina@mail.com</span>
            </div>
            <div class="d-flex align-items-center mb-2 pb-1">
              <span class="text-secondary">Phone Number:</span>
      ...
      <div class="col-xxl-3 col-lg-4 col-sm-6">
        <div class="card bg-white border-0 rounded-3 mb-4">
          <div class="card-body p-4">
            ...
            <div class="d-flex align-items-center mb-2 pb-1">
              <span class="text-secondary">Email Address:</span>
              <span class="ms-1">melvin@mail.com</span>
            </div>
            <div class="d-flex align-items-center mb-2 pb-1">
              <span class="text-secondary">Phone Number:</span>
