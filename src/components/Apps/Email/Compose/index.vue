              ...
              <div class="col-lg-6">
                <div class="form-group mb-4">
                  ...
                  >
                    ...
                    <option value="1">james@mail.com</option>
                    <option value="2">andy@mail.com</option>
                    <option value="3">mateo@mail.com</option>
                    <option value="4">luca@mail.com</option>
                    <option value="5">luca@mail.com</option>
                    <option value="6">tomato@mail.com</option>
                  </select>
                </div>
              </div>
              <div class="col-lg-6">
...
import EmailSidebar from "../../Email/EmailSidebar.vue";
