  ...
  <div class="card bg-white border-0 rounded-3 mb-4">
    <div class="card-body py-md-5 p-4">
      <div class="text-center mw-548 m-auto mb-5">
        ...
        <p>
          Trz offers customization options to tailor the platform to your
      ...
      <div class="accordion faq-wrapper mw-740 m-auto" id="accordionExample">
        <div class="accordion-item mb-3 border-0">
          ...
          >
            <div class="accordion-body">
              <p>
                Trz is a comprehensive project management software designed to
        ...
        <div class="accordion-item mb-3 border-0">
          <h2 class="accordion-header">
            ...
            >
              Is Trz suitable for small businesses?
            </button>
          </h2>
          <div
            id="collapseThree4"
        ...
        <div class="accordion-item mb-3 border-0">
          <h2 class="accordion-header">
            ...
            >
              Can I customize Trz to fit my team's specific needs?
            </button>
          </h2>
          <div
            id="collapseThree5"
        ...
        <div class="accordion-item mb-3 border-0">
          <h2 class="accordion-header">
            ...
            >
              Is Trz cloud-based or on-premises?
            </button>
          </h2>
          <div
            id="collapseThree6"
        ...
        <div class="accordion-item mb-3 border-0">
          <h2 class="accordion-header">
            ...
            >
              Does Trz integrate with other tools?
            </button>
          </h2>
          <div
            id="collapseThree7"
        ...
        <div class="accordion-item mb-3 border-0">
          <h2 class="accordion-header">
            ...
            >
              Can I try Trz before purchasing?
            </button>
          </h2>
          <div
            id="collapseThree9"
        ...
        <div class="accordion-item mb-3 border-0">
          <h2 class="accordion-header">
            ...
            >
              What type of customer support does Trz provide?
            </button>
          </h2>
          <div
            id="collapseThree10"
        ...
        <div class="accordion-item mb-3 border-0">
          <h2 class="accordion-header">
            ...
            >
              Does Trz offer training for new users?
            </button>
          </h2>
          <div
            id="collapseThree12"
        ...
        <div class="accordion-item mb-3 border-0">
          <h2 class="accordion-header">
            ...
            >
              Can I cancel my Trz subscription at any time?
            </button>
          </h2>
          <div
            id="collapseThree16"
        ...
        <div class="accordion-item mb-3 border-0">
          <h2 class="accordion-header">
            ...
            >
              Can I track time spent on tasks with Trz?
            </button>
          </h2>
          <div
            id="collapseThree17"
        ...
        <div class="accordion-item mb-3 border-0">
          <h2 class="accordion-header">
            ...
            >
              Does Trz offer recurring task capabilities?
            </button>
          </h2>
          <div
            id="collapseThree18"
        ...
        <div class="accordion-item mb-3 border-0">
          <h2 class="accordion-header">
            ...
            >
              Does Trz offer Gantt chart functionality?
            </button>
          </h2>
          <div
            id="collapseThree19"
        ...
        <div class="accordion-item mb-0 border-0">
          <h2 class="accordion-header">
            ...
            >
              Can I generate custom reports in Trz?
            </button>
          </h2>
          <div
            id="collapseThree20"
