        ...
        <div class="card-body p-4">
          ...
          <div class="tab-content" id="myTabContent">
            <div
              ...
              tabindex="0"
            >
              <h1 class="fs-1">Hello Trz</h1>
              <h2 class="fs-2">Hello Trz</h2>
              <h3 class="fs-3">Hello Trz</h3>
              <h4 class="fs-4">Hello Trz</h4>
              <h5 class="fs-5">Hello Trz</h5>
              <h6 class="fs-6">Hello Trz</h6>
              <p class="text-gray-light">
                Lorem ipsum <span class="text-success">dolor</span>, sit amet
                consectetur adipisicing elit. Aliquam aliquid vel porro natus?
                Est culpa aliquid, cumque
                <span class="text-dark">eligendi</span> inventore laborum, sit
                <span class="text-danger">incidunt</span> accusamus nesciunt
                vitae recusandae quos eaque saepe? Laudantium.
              </p>
              <p class="text-gray-light">
                Lorem ipsum <span class="mark">dolor</span>, sit amet
                consectetur adipisicing elit. Aliquam aliquid vel porro natus?
                Est culpa aliquid, cumque
                <span class="mark">eligendi</span> inventore laborum, sit
                <span class="mark">incidunt</span> accusamus nesciunt vitae
                <em class="text-dark">recusandae</em> quos eaque saepe?
                Laudantium.
              </p>
              <p class="text-gray-light">
                Lorem
                <span
                  class="d-inline-block text-primary bg-primary px-2 rounded-2 bg-opacity-10"
                  >Laudantium</span
                >
                ipsum <span class="text-success">dolor</span>, sit amet
                consectetur adipisicing elit.
                <span class="d-inline-block text-white bg-danger px-2 rounded-2"
                  >Laudantium</span
                >
                Aliquam aliquid vel porro natus? Est culpa aliquid, cumque
                <span class="text-dark">eligendi</span> inventore laborum, sit
                <span class="text-danger">incidunt</span> accusamus nesciunt
                vitae recusandae quos eaque saepe?
                <span
                  class="d-inline-block text-white bg-primary px-2 rounded-2"
                  >Laudantium</span
                >.
              </p>
            </div>
