  ...
  <div class="card bg-white border-0 rounded-3 mb-4">
    <div class="card-body p-0">
      ...
      <div class="default-table-area style-two all-products">
          ...
          <table class="table align-middle">
            ...
            <tbody>
              <tr>
                ...
                <td class="text-secondary">marcia@mail.com</td>
              ...
              <tr>
                ...
                <td class="text-secondary">barnes@mail.com</td>
              ...
              <tr>
                ...
                <td class="text-secondary">donna@mail.com</td>
              ...
              <tr>
                ...
                <td class="text-secondary">cross@mail.com</td>
              ...
              <tr>
                ...
                <td class="text-secondary">block@mail.com</td>
              ...
              <tr>
                ...
                <td class="text-secondary">ramiro@mail.com</td>
              ...
              <tr>
                ...
                <td class="text-secondary">robert@mail.com</td>
              ...
              <tr>
                ...
                <td class="text-secondary">haddock@mail.com</td>
                <td class="text-secondary">Washington D.C</td>
                <td class="text-secondary">+1 555-455-9966</td>
              ...
              <tr>
                ...
                <td class="text-secondary">wildon@mail.com</td>
                <td class="text-secondary">San Diego</td>
                <td class="text-secondary">+1 555-333-2288</td>
              ...
              <tr>
                ...
                <td class="text-secondary">hulsey@mail.com</td>
                <td class="text-secondary">Chicago</td>
                <td class="text-secondary">+1 555-445-7788</td>
                <td class="text-secondary">6</td>
        ...
        <PaginationTwo class="p-4" items="5" total="30" />
      </div>
    </div>
  </div>
  ...
  <div class="card bg-white border-0 rounded-3 mb-4">
    <div class="card-body p-4">
      ...
      <div class="default-table-area all-products">
        ...
        <PaginationTwo items="5" total="30" />
      </div>
    </div>
  </div>
</template>
