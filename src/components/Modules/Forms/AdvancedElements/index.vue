    ...
    <div class="col-lg-12">
      <div class="card bg-white border-0 rounded-3 mb-4">
        <div class="card-body p-4">
          <h4 class="fs-18 mb-4">Select Components</h4>
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  <div class="form-group mb-4">
                    ...
                    <div
                      class="tag-container p-1 rounded-3 form-control h-auto p-0"
                      id="tagContainer"
                    >
                      <input
                        type="text"
                        id="tagInput"
                        class="form-control h-49 border-0"
                  ...
                  <div class="form-group mb-4">
                    ...
                    <div class="form-group position-relative">
                      <select
                        ...
                        aria-label="Default select example"
                      >
                        <option selected class="text-dark">Trz</option>
...
<div>            &lt;div class="form-group position-relative"&gt;</div>
<div>                &lt;select class="form-select form-control h-60" aria-label="Default select example"&gt;</div>
<div>                    &lt;option selected class="text-dark"&gt;Trz&lt;/option&gt;</div>
                      ...
                      <div class="col-12">
                        ...
                        <div class="input-group h-60 form-control p-0">
                          <div class="input-group-text rounded-3 px-3">
                            <img
                              src="@/assets/images/united-states.jpg"
                              alt="united-states"
                            />
                          ...
                          <input
                            type="number"
                            class="form-control h-auto border-0 text-dark"
                  ...
                  <div class="col-lg-4">
                    <div class="form-group mb-4">
                      <label class="label text-secondary"
                        >Taggable Select</label
                      >
                      <div class="form-group position-relative">
                        <select
                          class="form-select form-control h-60 ps-5"
                          aria-label="Default select example"
                        >
            ...
            >
              ...
              <div class="border-top border-bottom py-3 mb-4">
                <div class="form-check">
                  ...
                  />
                  <label
                    class="form-check-label text-dark fs-14"
              ...
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <div class="product-quantity w-100">
                    <QuantityCounter class="gap-2 justify-content-between" />
                  </div>
                </div>
                <div class="col-lg-6">
                  <label class="label d-block">Light</label>
              ...
              <div class="row">
                ...
                <div class="col-lg-3 col-sm-6 mb-4">
                  ...
                  <div class="product-quantity bg-e2e8f0">
                    <QuantityCounterTwo
                      class="gap-3 justify-content-between"
                      btnColor="bg-white text-primary"
...
import QuantityCounterTwo from "./QuantityCounterTwo.vue";
