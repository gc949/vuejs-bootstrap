              ...
              <form class="row g-3 needs-validation" novalidate>
                <div class="col-md-6">
                  <label
                    ...
                    class="form-label label text-secondary"
                    >First name</label
                  >
                  <div class="position-relative">
                    <input
                      type="text"
                      class="form-control h-55 ps-5"
                    ...
                    <i
                      class="ri-user-line position-absolute top-0 start-0 fs-20 text-gray-light ps-20"
                ...
                <div class="col-md-6">
                  ...
                  <div class="position-relative">
                    ...
                    <div class="valid-feedback">Looks good!</div>
                    <i
                      class="ri-mail-line position-absolute top-0 start-0 fs-20 text-gray-light ps-20"
                      style="top: 13px !important"
                    ></i>
                  </div>
                </div>
                <div class="col-md-6">
                  ...
                  <div class="position-relative">
                    <input
                      type="number"
                      class="form-control h-55 ps-5 text-dark"
                    ...
                    <div class="valid-feedback">Looks good!</div>
                    <i
                      class="ri-phone-line position-absolute top-0 start-0 fs-20 text-gray-light ps-20"
                      style="top: 13px !important"
                    ></i>
                  </div>
                </div>
                <div class="col-md-12">
                  ...
                  <div class="position-relative">
                    ...
                    <i
                      class="ri-map-pin-line position-absolute top-0 start-0 fs-20 text-gray-light ps-20"
                      style="top: 13px !important"
                    ></i>
                  </div>
                </div>
                <div class="col-md-4">
                  ...
                  <div class="position-relative">
                    <select
                      class="form-select form-control h-55 ps-5"
                    ...
                    <i
                      class="ri-building-line position-absolute top-0 start-0 fs-20 text-gray-light ps-20"
                      style="top: 13px !important"
                    ></i>
                  </div>
                </div>
                <div class="col-md-4">
                  ...
                  <div class="position-relative">
                    ...
                    <i
                      class="ri-building-4-line position-absolute top-0 start-0 fs-20 text-gray-light ps-20"
                      style="top: 13px !important"
                    ></i>
                  </div>
                </div>
                <div class="col-md-4">
                  ...
                  <div class="position-relative">
                    ...
                    <i
                      class="ri-inbox-unarchive-line position-absolute top-0 start-0 fs-20 text-gray-light ps-20"
                      style="top: 13px !important"
                    ></i>
                  </div>
                </div>
                <div class="col-md-12">
                  ...
                  <div class="position-relative">
                    ...
                    <i
                      class="ri-sticky-note-line position-absolute top-0 start-0 fs-20 text-gray-light ps-20"
                      style="top: 13px !important"
                    ></i>
                  </div>
                </div>
                ...
                <div class="col-12">
                  <button
                    class="btn btn-primary fw-semibold text-white py-2 px-3"
                    type="submit"
                  >
                    Submit Form
                  </button>
...
<div>        &lt;div class="position-relative"&gt;</div>
<div>            &lt;input type="email" class="form-control h-55 ps-5" id="validationCustom03" value="trz@gmail.com" required&gt;</div>
<div>            &lt;div class="valid-feedback"&gt;</div>
<div>                Looks good!</div>
<div>            &lt;/div&gt;</div>
...
<div>        &lt;div class="position-relative"&gt;</div>
<div>            &lt;input type="email" class="form-control h-55" id="validationCustom12" value="trz@gmail.com" required&gt;</div>
<div>            &lt;div class="valid-feedback"&gt;</div>
<div>                Looks good!</div>
<div>            &lt;/div&gt;</div>
<div>        &lt;/div&gt;</div>
